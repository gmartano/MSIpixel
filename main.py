...
class Main(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.pushButton.clicked.connect(self.open_manual)
        self.w = None

    def open_manual(self):
        pdf_file_path = os.path.join(w_dir, "User_manual.pdf")
    ...
    def click_process_infusion(self):
        ...
        if len(self.lib) == 0:
            ...
            return
        self.ui.checkBox_inf1.setVisible(True)
        self.ui.checkBox_inf2.setVisible(True)
        self.ui.checkBox_inf3.setVisible(True)
    ...
    def run_spatial(self):
        self.ui.progressBar_spat.setVisible(True)
        self.ui.progressBar_spat.setRange(0,0)
        all_eic, all_eim, df = func.imz_filters(self.all_eic, self.all_eim, self.df, self.thr, self.perc_pixel, self.minimum_score)
        if len(all_eim) > 0:
            self.all_eic, self.all_eim, self.df = all_eic, all_eim, df
        else:
            self.warning_messagge("Unble to filter the data.\n No remaining features.\n Change filter parameters")
            self.ui.checkBox_spat.setVisible(False)
    ...
    def initial_app(self):
        self.ui.checkBox_inf1.setVisible(False)
        self.ui.checkBox_inf2.setVisible(False)
        self.ui.checkBox_inf3.setVisible(False)
        self.ui.checkBox_spat.setVisible(False)
        self.ui.checkBox_hmdb.setVisible(False)
        self.ui.checkBox_hmdb1.setVisible(False)
